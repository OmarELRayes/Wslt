...
public class Geofencing implements ResultCallback {
    ...
    private static final long GEOFENCE_TIMEOUT = 1 * 60 * 60 * 1000; // 24 hours
    ...
    private Geofencing(Context context, GoogleApiClient client) {
        mContext = context;
    ...
    public static Geofencing getInstance(Context context, @Nullable GoogleApiClient client) {
        if (geofencing != null)
            return geofencing;
        geofencing = new Geofencing(context, client);
        return geofencing;
    }
    ...
    public void registerAllGeofences() {
        ...
        try {
            ...
            SharedPreferencesHelper.storeDataToSharedPref(mContext, "on", "geofence");
    ...
    public void unRegisterAllGeofences() {
        SharedPreferencesHelper.storeDataToSharedPref(mContext, "off", "geofence");
        Log.i(TAG, "unRegisterAllGeofences: ");
        if (mGoogleApiClient == null || !mGoogleApiClient.isConnected()) {
            return;
        }
        try {
     ...
     *
     */
    public void updateGeofencesList(LatLng destination) {
        mGeofenceList = new ArrayList<>();
        ...
        Geofence geofence = new Geofence.Builder()
                ...
                .setCircularRegion(destination.latitude, destination.longitude, GEOFENCE_RADIUS)
